...
console.log('idades', idades); // filter

var timeRocketseat = usuarios.filter(function (usuario) {
  return usuario.empresa === 'Rocketseat' && usuario.idade > 18;
});
console.log('Time Rocketseat', timeRocketseat); // find

var googler = usuarios.find(function (usuario) {
  return usuario.empresa == 'Google';
});
console.log('Googler', googler); // Unindo operações

var usuariosEditados = usuarios.map(function (usuario) {
